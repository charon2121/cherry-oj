...
| WORK-049 | 按命令执行顺序重构 Go 判题引擎源码 | 整理维护 | 验证通过 | 高 | 多个模块 | codex/root | [00-work.md](./works/WORK-049/00-work.md) |
| WORK-050 | 将沙箱已验收回归固化为重构 CI | 基础能力 | 验证通过 | 高 | 多个模块 | codex/root | [00-work.md](./works/WORK-050/00-work.md) |
...
| WORK-059 | 业务闭环中 PATCH /api/admin/problems/{id} 偶发 500 且证据不可定位 | 问题修复 | 执行中 | 中 | 多个模块 | team/server | [00-work.md](./works/WORK-059/00-work.md) |
