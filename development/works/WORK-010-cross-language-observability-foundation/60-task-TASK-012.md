...
verifies: []
tags: []
read_paths: ["CLAUDE.md", ".claude/rules/go.md", "contracts", "docs/architecture.md", "docs/backend.md", "apps/judge-engine", "development/works/WORK-010-cross-language-observability-foundation"]
write_paths: ["apps/judge-engine", "development/works/WORK-010-cross-language-observability-foundation"]
forbidden_paths: ["apps/server", "apps/web", "contracts", "compose.yaml", "docs/data-model.md", "docs/database-design.md", "development/works/WORK-002-cpp-acm-loop"]
