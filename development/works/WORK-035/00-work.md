...
| 开发任务 | ○ 就绪 | 必需 | TASK-056 `done`、TASK-057 `todo`、TASK-058 `todo` | 拆成可独立完成并验证的任务，划定可读、可写与禁止范围 |
| 开发 | · 未开始 | 必需 | TASK-056 `done`、TASK-057 `todo`、TASK-058 `todo` | 按任务实施，产出代码与测试 |
| 复核 | · 未开始 | 必需 | — | 独立复核实现是否符合定义与方案，边界有没有被越过 |
| 回归验证 | · 未开始 | 必需 | VERIFY-036 `draft` | 用可复现的证据确认要求逐条满足 |
