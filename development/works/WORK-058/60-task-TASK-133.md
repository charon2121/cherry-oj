...
- 2026-09-22：用户要求整理提交并进行 CI。修复提交 35d1d1c 的首次 CI 暴露业务采样 OSError，
  补修 c32b87f 经独立复审后推送；完整 CI 35700329069 的 12 个 job、93 项必需回归全部通过。
  提交分组、首轮失败、采样补修和最终证据均见 VERIFY-059，WORK-059 原有增量未纳入。
