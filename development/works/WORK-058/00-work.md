...
| 开发任务 | ○ 就绪 | 必需 | TASK-125 `done`、TASK-126 `done`、TASK-127 `done`、TASK-128 `doing`、TASK-129 `todo`、TASK-130 `ready`、TASK-131 `todo` | 拆成可独立完成并验证的任务，划定可读、可写与禁止范围 |
| 开发 | ▶ 进行中 | 必需 | TASK-125 `done`、TASK-126 `done`、TASK-127 `done`、TASK-128 `doing`、TASK-129 `todo`、TASK-130 `ready`、TASK-131 `todo` | 按任务实施，产出代码与测试 |
