...
| 改进说明与目标指标 | ▶ 进行中 | 必需 | IMPROVEMENT-003 `review` | 说清楚这件事要达成什么、边界在哪、怎样算完成 |
| 技术方案 | ▶ 进行中 | 必需 | DESIGN-030 `review` | 确定技术方案、边界与取舍 |
| 技术决策 | ▶ 进行中 | 必需 | DECISION-020 `review` |  |
| 开发计划 | ▶ 进行中 | 必需 | PLAN-024 `review` | 拆成阶段与顺序，说明并行、依赖、迁移与回退 |
| 实施任务 | · 未开始 | 必需 | TASK-059 `todo`、TASK-060 `todo`、TASK-061 `todo`、TASK-062 `todo`、TASK-063 `todo` | 拆成可独立完成并验证的任务，划定可读、可写与禁止范围 |
| 实施 | · 未开始 | 必需 | TASK-059 `todo`、TASK-060 `todo`、TASK-061 `todo`、TASK-062 `todo`、TASK-063 `todo` | 按任务实施，产出代码与测试 |
