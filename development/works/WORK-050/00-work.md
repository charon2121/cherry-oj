...
| 开发任务 | ○ 就绪 | 必需 | TASK-109 `done`、TASK-110 `done`、TASK-111 `doing`、TASK-112 `todo`、TASK-113 `todo`、TASK-115 `done` | 拆成可独立完成并验证的任务，划定可读、可写与禁止范围 |
| 开发 | ▶ 进行中 | 必需 | TASK-109 `done`、TASK-110 `done`、TASK-111 `doing`、TASK-112 `todo`、TASK-113 `todo`、TASK-115 `done` | 按任务实施，产出代码与测试 |
