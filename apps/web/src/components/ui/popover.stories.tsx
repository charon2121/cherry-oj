  ...
  render: () => (
    <Popover>
      ...
      <PopoverContent>
        ...
        <a
          className="focus-visible:outline-ring text-link hover:text-link-hover underline decoration-1 underline-offset-[0.18em] focus-visible:outline-1 focus-visible:outline-offset-0"
