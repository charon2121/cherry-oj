...
| 动任何 Web UI、组件、样式或主题 | [`docs/design-system/PROMPT.md`](./docs/design-system/PROMPT.md)：先选页面模板，再按页面语法写，交付前逐条回答自检七问。规则全文见 [`docs/design-system.md`](./docs/design-system.md)；设计值只在 `apps/web/design-system/` 手写一次，禁止把来源 demo 直接当生产代码 |
